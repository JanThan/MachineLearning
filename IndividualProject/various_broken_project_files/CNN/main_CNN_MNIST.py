...
#CNN_model = train_CNN.train_model(packet, save_model = 'False')
CNN_model = load_CNN.load_model(packet)

#subSVM1, subSVM2, subSVM3, features = train_subSVMs.train(CNN_model, data, c=0.1, save_model = 'True', get_accuracies= 'False')
...
#final_SVM = train_finalSVM.train(data, features, subSVMs, number_of_classes, get_accuracies='False')
