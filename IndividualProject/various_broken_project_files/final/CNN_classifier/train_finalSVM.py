...
def get_subSVM_outs(features, data, subSVMs, number_of_classes):
  ...
  for i in range(number_of_classes):
    ...
    print(i)
#    subSVM1_train_out[:,i] = subSVM1[i].decision_function(feature1_train)[0]
#    subSVM1_test_out[:,i] = subSVM1[i].decision_function(feature1_test)[0]
#    subSVM2_train_out[:,i] = subSVM2[i].decision_function(feature2_train)[0]
#    subSVM2_test_out[:,i] = subSVM2[i].decision_function(feature2_test)[0]
#    subSVM3_train_out[:,i] = subSVM3[i].decision_function(feature3_train)[0]
#    subSVM3_test_out[:,i] = subSVM3[i].decision_function(feature3_test)[0]
