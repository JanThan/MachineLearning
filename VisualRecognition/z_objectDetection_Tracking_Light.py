...
# -------------------------- # Model preparation # --------------------------- #
# Downloading prebuilt model to run object detection on.
#

# Name of folder that the frozen inference graph is stored in
MODEL_NAME = 'puck_model'
# Path to frozen detection graph.
PATH_TO_CKPT = MODEL_NAME + '/frozen_inference_graph.pb'

# List of the strings that is used to add correct label for each box.
PATH_TO_LABELS = os.path.join('training', 'puck_label.pbtxt')
